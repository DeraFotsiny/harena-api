...
public class PossessionService {
    ...
    public List<PossessionAvecType> crupdatePossession(String patrimoineName, List<PossessionAvecType> possessions) {
        List<Possession> possessionList = possessions.stream()
                .map(PossessionAvecType::toPossession)
    ...
    public void deletePossessionByName(String patrimoineName, String possessionName) {
        List<PossessionAvecType> possessions = getPatrimoinePossessions(patrimoineName);
        possessions = possessions.stream()
    ...
    public List<PossessionAvecType> paginatePossessions(List<PossessionAvecType> possessions, int page, int pageSize) {
