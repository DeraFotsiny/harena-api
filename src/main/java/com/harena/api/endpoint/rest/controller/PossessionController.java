...
public class PossessionController {
  ...
  public List<PossessionAvecType> crupdatePossession(
    ...
    List<PossessionAvecType> crupdatePossession =
        possessionService.crupdatePossession(patrimoineName, possessions);
  ...
  public List<PossessionAvecType> getPatrimoinePossessions(
      ...
      @RequestParam(value = "page", defaultValue = "1") int page,
      @RequestParam(value = "page_size") int pageSize) {
    List<PossessionAvecType> possessions =
        possessionService.getPatrimoinePossessions(patrimoineName);
